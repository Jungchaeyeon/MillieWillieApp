...
import com.makeusteam.milliewillie.databinding.ActivityWorkoutStartBinding
...
import com.makeusteam.milliewillie.ui.workoutStart.adapter.WorkoutStartAdapter
...
//        startItemList = viewModel.createRecycler()
    ...
    fun stopWatch() {
        ...
        when (isStart) {
            ...
            false -> {
                binding.startBtnStart.text = globalApplicationContext.getString(R.string.start)
    ...
    fun onClickDone() {
        DialogWorkoutDoneFragment.getInstance()
            .setTitle(globalApplicationContext.getString(R.string.is_done_ex))
            .setOnClickOk ({
