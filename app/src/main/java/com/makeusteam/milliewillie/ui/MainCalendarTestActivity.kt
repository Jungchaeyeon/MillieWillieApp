...
import com.makeusteam.milliewillie.databinding.ItemMainCalTestScheduleBinding
...
class MainCalendarTestActivity :
    ...
    override fun onResume() {
      ...
      //  getMainCalendarDay(mWidget)
        ...
        binding.layoutDay.visibility=View.INVISIBLE
        binding.txtBlank.visibility=View.INVISIBLE
       // getMainCalendarDay(mWidget, CalendarDay.today())
    }
    }
